"""
Simple script to update bot.py to the latest version
"""
import os
...
# Write to file
bot_path = os.path.join("discord_bot", "bot.py")
with open(bot_path, "w", encoding="utf-8") as f:
    f.write(BOT_CONTENT)

print(f"✅ Successfully updated {bot_path}")
print("\nNow fix your .env file:")
print("1. Open .env in Notepad")
print("2. Find the line: DISCORD_BOT_TOKEN= MTQ...")
print("3. Remove the space after =")
print("4. Save the file")
print("\nThen run: python discord_bot\\bot.py")
